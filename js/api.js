...
const API = (() => {
  ...
  const MOCK = {
    ...
    members: [
      {
        ...
        joinDate: '2020-06-01', password: 'Admin@DD2026',
      },
      {
        ...
        joinDate: '2020-06-01', password: 'DD-002',
      },
      {
        ...
        joinDate: '2020-06-01', password: 'DD-003',
      },
      {
        ...
        joinDate: '2021-01-15', password: 'DD-004',
      },
      {
        ...
        joinDate: '2021-03-10', password: 'DD-005',
      },
      {
        ...
        joinDate: '2021-06-20', password: 'DD-006',
      },
    ],
    ...
    // ── Gallery ────────────────────────────────────────────────────────────────
    gallery: [
      { id:'g1', url:'https://picsum.photos/seed/dd1/640/430', caption:'Annual General Meeting 2025',        date:'2025-12-10' },
      { id:'g2', url:'https://picsum.photos/seed/dd2/640/430', caption:'Team Building Workshop',             date:'2025-11-05' },
      { id:'g3', url:'https://picsum.photos/seed/dd3/640/430', caption:'Investment Strategy Seminar',        date:'2025-10-22' },
      { id:'g4', url:'https://picsum.photos/seed/dd4/640/430', caption:'Executive Committee Inauguration',   date:'2026-04-23' },
      { id:'g5', url:'https://picsum.photos/seed/dd5/640/430', caption:'Community Iftar Programme 2026',     date:'2026-04-01' },
      { id:'g6', url:'https://picsum.photos/seed/dd6/640/430', caption:'CSR — School Supplies Drive',        date:'2026-02-14' },
      { id:'g7', url:'https://picsum.photos/seed/dd7/640/430', caption:'Financial Planning Roundtable',      date:'2025-09-18' },
      { id:'g8', url:'https://picsum.photos/seed/dd8/640/430', caption:'Founding Day Celebration, Year 5',   date:'2025-06-01' },
    ],
    ...
    credentials: {
      // Admin (email-based)
      'admin@dd.org' : { type:'admin',  password:'Admin@DD2026', memberId:'m1' },
      // Members (ID-based — default password = their Member ID)
      'DD-001'       : { type:'member', password:'DD-001',       memberId:'m1' },
      'DD-002'       : { type:'member', password:'DD-002',       memberId:'m2' },
      'DD-003'       : { type:'member', password:'DD-003',       memberId:'m3' },
      'DD-004'       : { type:'member', password:'DD-004',       memberId:'m4' },
      'DD-005'       : { type:'member', password:'DD-005',       memberId:'m5' },
      'DD-006'       : { type:'member', password:'DD-006',       memberId:'m6' },
    },
  };
  ...
  const adminLogin = async (email, password) => {
    if (CONFIG.USE_MOCK) {
      const cred = MOCK.credentials[email.toLowerCase()];
  ...
  const memberLogin = async (memberId, password) => {
    if (CONFIG.USE_MOCK) {
      ...
      if (!cred || cred.type !== 'member' || cred.password !== password)
        throw new Error('Invalid Member ID or password. Default password is your Member ID.');
      const member = MOCK.members.find((m) => m.id === cred.memberId);
  ...
  const createMember = async (data) => {
    if (CONFIG.USE_MOCK) {
      ...
      const m = {
        ...
        password : memberId,           // default password = their ID
        photo    : `https://i.pravatar.cc/200?img=${30 + MOCK.members.length}`,
        nidPhoto : null, signaturePhoto: null,
        ...data,
      };
      MOCK.members.push(m);
      MOCK.credentials[memberId] = { type:'member', password:memberId, memberId:m.id };
      return delay(m);
    }
  ...
  const updateMember = async (id, data) => {
    if (CONFIG.USE_MOCK) {
      ...
      if (data.memberId && data.memberId !== old.memberId) {
        ...
        MOCK.credentials[data.memberId] = { type:'member', password:data.memberId, memberId:id };
      }
  ...
  const getGallery = async (page=1) => {
    if (CONFIG.USE_MOCK) {
      ...
      return delay({ data:MOCK.gallery.slice(start,start+limit), total:MOCK.gallery.length, totalPages:Math.ceil(MOCK.gallery.length/limit) });
    }
